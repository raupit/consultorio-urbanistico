...
const PROBLEMS = [
  {
    icon: AlertTriangle,
    title: "Obras sin licencia",
    desc: "Ampliaciones sin permiso, naves no declaradas, masías con construcciones fuera de ordenación. Sin documentación técnica, el comprador impone su precio.",
    stat: "Alto",
  ...
  },
  {
    ...
    desc: "Suelo rústico cuyo aprovechamiento desconoces. Mientras no estudias qué permite el planeamiento, pagas IBI sin obtener rentabilidad.",
    stat: "0€",
...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Dictamen pericial de valoración para procedimientos judiciales: herencias, división de cosa común, ejecuciones hipotecarias. Elaborado conforme a la metodología pericial y con ratificación ante el juzgado si es necesaria.",
    features: ["Dictamen pericial de valoración", "Herencias y división de cosa común", "Deslinde de cuotas", "Ratificación ante el juzgado"],
  },
  {
    icon: Stamp,
...
const FAQS = [
  {
    q: "Tengo una obra sin licencia de hace muchos años. ¿Se puede legalizar?",
    a: "Depende del planeamiento del municipio, del tipo de suelo y de cuándo se construyó. Hay obras legalizables, otras que pueden quedar en situación de fuera de ordenación (se conservan pero con limitaciones) y otras con expediente abierto que requieren actuar rápido. Por eso el primer paso es siempre el estudio de viabilidad: sin él, cualquier respuesta es una suposición.",
  },
  {
    q: "¿Qué significa exactamente 'fuera de ordenación'?",
    a: "Es la situación de construcciones que no se ajustan al planeamiento vigente pero contra las que ya no cabe orden de derribo por el paso del tiempo. Se pueden conservar y usar, aunque con limitaciones en las obras permitidas. Documentar correctamente esta situación es clave para poder vender la propiedad sin que el comprador la use como arma de rebaja.",
  },
  {
    q: "¿Qué diferencia hay entre un perito urbanístico y un arquitecto?",
    a: "Son perfiles complementarios. El arquitecto o arquitecto técnico colegiado redacta y firma proyectos (de legalización, de obra). El perito judicial urbanístico analiza la situación legal-urbanística, valora la propiedad y elabora dictámenes con validez en procedimientos judiciales. En mi caso, cuando un trámite requiere proyecto técnico, coordino el caso con técnicos colegiados de confianza.",
  },
  {
    q: "He heredado una finca y el Registro no coincide con la realidad. ¿Es grave?",
    a: "Es muy frecuente y casi siempre tiene solución, pero bloquea la venta si no se resuelve antes: excesos de cabida, construcciones no inscritas, datos catastrales desactualizados. Lo grave no es la discrepancia: es descubrirla en la notaría, con el comprador delante. El estudio previo evita exactamente eso.",
  },
  {
    q: "¿Cuánto cuesta y cuánto tarda?",
    a: "La consulta inicial son 50€, deducibles si contratas el servicio. El estudio de viabilidad va de 200 a 500€ y el dictamen pericial de 500 a 2.000€, según superficie, municipio y complejidad. Los plazos dependen de cada caso y de los tiempos del ayuntamiento; te doy una estimación realista tras estudiar tu documentación, no antes.",
  },
  {
    q: "¿Y si mi caso no tiene solución?",
    a: "Te lo digo. Mi trabajo es darte el diagnóstico real, no venderte humo: hay casos legalizables, casos conservables con limitaciones y casos donde la mejor estrategia es vender con la situación documentada y el precio bien defendido. Saber en cuál estás ya cambia tu posición negociadora.",
  },
];
...
export default function ConsultorioHome() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://formspree.io/f/mojbnkdb", {
        ...
        body: JSON.stringify({
          ...formData,
          origen: "consultorio-urbanistico",
  ...
  return (
    <div className="min-h-screen bg-[#F5F2E8] text-[#1a1a1a] font-sans pb-16 lg:pb-0">
      {/* WhatsApp flotante */}
      <a
        href="https://wa.me/34632831009?text=Hola%20Ana%2C%20quiero%20consultarte%20una%20propiedad%20con%20dudas%20urban%C3%ADsticas."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="WhatsApp"
        className="hidden lg:flex fixed bottom-6 right-6 z-[60] items-center gap-2 rounded-full bg-[#25D366] hover:bg-[#1faa52] text-white font-bold px-5 py-3 shadow-xl shadow-black/20 transition-colors"
      >
      ...
      <div className="lg:hidden fixed bottom-0 inset-x-0 z-[60] grid grid-cols-2 border-t border-black/10 bg-[#F5F2E8]/95 backdrop-blur">
        <a
          href="tel:+34632831009"
          className="flex items-center justify-center gap-2 py-4 font-bold text-sm text-[#3A4D39]"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 py-4 font-bold text-sm text-white bg-[#25D366]"
        >
      ...
      {/* ═══════════════ DIFERENCIAL ═══════════════ */}
      <section className="py-14 bg-[#3A4D39]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="rounded-2xl border border-[#D4AF37]/25 bg-[#2d3d2c] p-8 md:p-10 text-center"
          >
            <p className="text-xs font-bold tracking-[0.2em] text-[#D4AF37] uppercase mb-4">
              Por qué es distinto trabajar conmigo
            </p>
            <h2 className="text-2xl md:text-3xl font-bold text-[#F5F2E8] leading-snug">
              Perito judicial <span className="text-[#D4AF37]">y</span> agente inmobiliaria.
              <br />
              <span className="font-serif italic text-[#D4AF37]">
                Quien estudia tu propiedad es quien sabe venderla.
              </span>
            </h2>
            <p className="mt-4 text-[#c5c0b4] max-w-2xl mx-auto leading-relaxed">
              El técnico te entrega un informe y se va. La inmobiliaria quiere publicar rápido y
              cobrar. Yo uno los dos criterios: analizo tu propiedad como perito —con la
              metodología que aguanta un juzgado— y la defiendo en la negociación como agente.
              Sin intermediarios entre el diagnóstico y la venta.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="rounded-2xl border border-[#D4AF37]/20 bg-[#2d3d2c] p-8">
              ...
              {formSubmitted ? (
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    disabled={formSending || !rgpdChecked || !formData.nombre || !formData.telefono}
                  ...
                  >
                    <Phone className="w-4 h-4 mr-2" />
                    {formSending ? "Enviando..." : "Consulta Exprés — Respuesta en 24h"}
                  </Button>
                  {formError && (
                    <p className="text-xs text-center text-red-400">
                      No se ha podido enviar. Inténtalo de nuevo o escríbeme por WhatsApp al 632 831 009.
                    </p>
                  )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm text-[#666] mb-3">
              ¿Lo tienes claro? Reserva directamente tu consulta de 50€ (deducibles del servicio):
            </p>
            <Button
              asChild
            ...
            >
              <a
                href="https://calendly.com/anaepitieinmobiliaria"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Calendar className="w-4 h-4 mr-2" />
                Reservar consulta en mi agenda
              </a>
            </Button>
            <p className="text-xs text-[#999] mt-2">Lunes a viernes · 10:00–13:00 y 16:00–18:00</p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="rounded-2xl border border-[#D4AF37]/20 bg-[#2d3d2c] p-8">
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={formSending || !formData.nombre || !formData.telefono || !rgpdChecked}
                  className="w-full bg-[#B8860B] hover:bg-[#9a7209] text-white font-bold text-base h-12 rounded-full shadow-lg shadow-[#B8860B]/20 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  <Send className="w-4 h-4 mr-2" />
                  {formSending ? "Enviando..." : formSubmitted ? "✓ Consulta enviada" : "Enviar consulta"}
                </Button>
                <p className="text-xs text-center text-[#9a978a]">
                  Marca la casilla de privacidad del formulario superior para poder enviar.
                </p>
              </form>
            </div>
          </motion.div>
      ...
      <section id="faq" className="py-20 md:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1a1a1a]">
              Lo que me preguntan{" "}
              <span className="font-serif italic text-[#3A4D39]">antes de enviar el caso</span>
            </motion.h2>
          </motion.div>
          ...
          >
            {FAQS.map((faq) => (
              <motion.details
                key={faq.q}
                variants={fadeUp}
                className="group rounded-2xl border border-[#3A4D39]/10 bg-[#F5F2E8] px-6 py-4 open:shadow-md transition-all"
              >
                <summary className="cursor-pointer list-none flex items-center justify-between gap-4 font-bold text-[#1a1a1a]">
                  {faq.q}
                  <ChevronRight className="w-4 h-4 text-[#3A4D39] flex-shrink-0 transition-transform group-open:rotate-90" />
                </summary>
          ...
          <motion.div
            ...
            className="text-center mt-10"
          >
            <p className="text-sm text-[#666] mb-3">¿Tu pregunta no está aquí?</p>
            <Button
              onClick={scrollToContact}
              className="bg-[#B8860B] hover:bg-[#9a7209] text-white font-bold rounded-full px-8 h-12"
            >
              Envíame tu caso y te respondo
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#servicios" className="hover:text-[#D4AF37] transition-colors">Estudio de Legalización</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#testimonios" className="hover:text-[#D4AF37] transition-colors">Situaciones habituales</a></li>
